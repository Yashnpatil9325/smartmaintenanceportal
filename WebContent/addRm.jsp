     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SMART MAINTENANCE PORTAL</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3>ADD ROAD MAINTENANCE</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form action="Roadmain" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter Road Name</label>
									<div class="col-sm-8">
										<input type="text" name="name" class="form-control1" id="focusedinput" placeholder="Enter Road Name ">
									</div>
									<div class="col-sm-2">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter Location</label>
									<div class="col-sm-8">
										<input type="text" name="location" class="form-control1" id="focusedinput" placeholder="Enter Location">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div>
									...
									try
									{
										...
										%> 
										<option> <%=i.getString("deptname")%></option>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter deadline date</label>
									<div class="col-sm-8">
										<input type="date" name="date" class="form-control1" id="focusedinput" placeholder="Enter deadline date">
									</div>
									<div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div>
