     ...
     <!-- Navigation -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                            <a href="viewdep.html"><i class="fa fa-dashboard fa-fw nav_icon"></i>VIEW DEPARTMENT</a>
                        </li>
      ...
      <table class="table table-bordered">
        ...
        try
		{
			...
			PreparedStatement ps2=con.prepareStatement("select * from addcom");
