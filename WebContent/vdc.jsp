     ...
     <!-- Navigation -->
      ...
      <table class="table table-bordered">
        ...
        try
		{
			...
			PreparedStatement ps2=con.prepareStatement("select * from addcom where department=?");
			ps2.setString(1,GetSet.getDept());
			...
			<tr>
	            ...
	            <td><a href="comments.html?id=<%=rs.getInt("id")%>">comment</a></td>>
	          </tr>
  <% 
			}
		}
